    ...
    Common(final ForgeConfigSpec.Builder builder) {
      ...
      fooBar =
          builder
              ...
              .translation("dababymod.config.common.fooBar")
              .define("fooBar", false);
      exampleEnumProperty =
          builder
              .comment("This is an example enum property.")
              .translation("dababymod.config.common.exampleEnumProperty")
  ...
  public static class Client {
    ...
    Client(final ForgeConfigSpec.Builder builder) {
      ...
      baz = builder
          ...
          .translation("dababymod.config.client.baz")
      ...
      exampleSubcategoryEnumProperty = builder
          ...
          .translation("dababymod.config.client.subcategory.exampleSubcategoryEnumProperty")
      ...
      exampleNestedEnumProperty = builder
          ...
          .translation("dababymod.config.client.exampleNestedEnumProperty")
